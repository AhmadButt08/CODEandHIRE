...
const ProfileCertificationModal = (props) => {
        ...
        <div className="relative bg-neutral-900 w-96 border-[1px] border-gray-600 rounded-lg shadow-lg">
          <form className="p-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                className=" bg-blue-200 text-blue-900 font-bold py-2 px-4 rounded mr-2"
...
export default ProfileCertificationModal;
